...
* 选择登陆，直接使用QQ登陆
* 选择注册，进入注册页面注册，需正确填写邮箱，以便接收验证链接进行注册信息验证。

#### 作者不太会前端，但是为了小伙伴们的方便，恶补了一下Bootstrap，新前台已经上线。
...
* 待开发
    ...
    * 用户相关
        * 邮箱用户头像展示与修改
        * 用户账号合并（QQ用户与邮箱用户合并，三合一登陆更加方便）
        * 邮箱验证码登陆
    * 前台相关
        * 响应式布局以适应手机、PAD等屏幕分辨率
