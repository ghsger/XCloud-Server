...
<form action="user/browse/login" class="box" method="post">
    <h1>login</h1>
    <input type="text" name="username" placeholder="username" id="username" onblur="formValid.checkUserName()" onclick="formClick.checkUserName()"/><span class="imsg" id="userInfo">请输入用户名</span>
    <input type="password" placeholder="password" name="password" id="password" onblur="formValid.checkPassword()" onclick="formClick.checkPassword()"/><span class="imsg" id="passwordInfo">请输入密码</span>
